...
var	mobileMenuTitle = "Menu",					//The title of the mobile menu
	...
	map_color = "#626262",						//Google map color
	...
	//COUNTDOWN VARIABLES
	c_days = "DIAS",							//Countdown "Days" label
	c_hours = "HORAS",							//Countdown "Hours" label
	c_minutes = "MIN.",							//Countdown "Minutes" label
	c_seconds = "SEG.",							//Countdown "Seconds" label
	countdownEndMsg = "Felizes para sempre!";			//Message to display when the countdown reaches the end
